...
let GameGateway = class GameGateway {
  ...
  handleEndOfTurn(client, rec) {
    ...
    client
      .to(rec.room)
      .emit(webSocketEvents_1.default.RECEIVE_NEXT_PHASE, message);
  }
  ...
  async handleClientJoined() {
    ...
    if (allSockets.size === 1) {
      return {
        event: webSocketEvents_1.default.YOU_ARE_HOST,
        data: 'You are the host',
      };
    }
  }
...
__decorate(
  [
    (0, websockets_1.SubscribeMessage)(
      webSocketEvents_1.default.SEND_NEXT_PHASE,
    ),
...
__decorate(
  [
    (0, websockets_1.SubscribeMessage)(
      webSocketEvents_1.default.SEND_MEEPLE_PLACED,
    ),
    __metadata('design:type', Function),
    __metadata('design:paramtypes', [socket_io_1.Socket, Object]),
    __metadata('design:returntype', void 0),
