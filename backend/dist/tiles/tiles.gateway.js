...
let TilesGateway = class TilesGateway {
  handleTilePlacementMessage(client, rec) {
    ...
    client
      .to(rec.room)
      .emit(webSocketEvents_1.default.RECEIVE_TILE_PLACED, message);
  }
  handleTileInHandRotated(client, rec) {
    const message = { rotation: rec.rotation, clientId: client.id };
    client
      .to(rec.room)
      .emit(webSocketEvents_1.default.RECEIVE_TILE_ROTATED, message);
  }
};
__decorate(
  [
    (0, websockets_1.SubscribeMessage)(
      webSocketEvents_1.default.SEND_TILE_PLACED,
    ),
    __metadata('design:type', Function),
    __metadata('design:paramtypes', [socket_io_1.Socket, Object]),
    __metadata('design:returntype', void 0),
  ],
  TilesGateway.prototype,
...
__decorate(
  [
    (0, websockets_1.SubscribeMessage)(
      webSocketEvents_1.default.SEND_TILE_ROTATED,
    ),
    __metadata('design:type', Function),
    __metadata('design:paramtypes', [socket_io_1.Socket, Object]),
    __metadata('design:returntype', void 0),
