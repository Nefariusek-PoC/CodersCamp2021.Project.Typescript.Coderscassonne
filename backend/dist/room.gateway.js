...
let RoomGateway = class RoomGateway {
  ...
  handleRoomCreate(client, room) {
    if (!exports.rooms.some((r) => r.room === room.name)) {
      ...
      client.broadcast.emit(
        webSocketEvents_1.default.SEND_ROOMS,
        exports.rooms
      ...
      this.wss.emit(
        webSocketEvents_1.default.CREATE_ROOM_ERROR,
  ...
  handleRoomJoin(client, room) {
    if (
      exports.rooms.some(
        (r) => r.room === room.name && r.password === room.password,
      )
    ) {
      if (exports.rooms.find((r) => r.room === room.name).players < 5) {
        ...
        client.emit(
          webSocketEvents_1.default.JOIN_ROOM_ERROR,
...
__decorate(
  [
    (0, websockets_1.SubscribeMessage)(
      webSocketEvents_1.default.RECEIVE_MESSAGE_FROM_ROOM,
    ),
